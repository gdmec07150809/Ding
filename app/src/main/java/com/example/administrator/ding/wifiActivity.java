    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent=new Intent(wifiActivity.this,editActivity.class);
                Bundle bundle=new Bundle();
                bundle.putString("keep",keep);
                bundle.putString("time",start_time);
                bundle.putString("lang",language);
                ...
                bundle.putString("device_name",scanResults.get(i).SSID);
                bundle.putString("device_mac",scanResults.get(i).BSSID);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        });
        ...
        automatic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // Toast.makeText(wifiActivity.this, "自动搜索", Toast.LENGTH_SHORT).show();
                isFlag=true;
                one_handler.sendEmptyMessageDelayed(1, 100);
